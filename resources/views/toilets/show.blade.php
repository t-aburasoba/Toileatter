        ...
        <div class="row text-center text-lg-left">
            ...
            <div class="col-lg-3 col-md-4 col-6">
                <a href="#" class="d-block mb-4 h-100">
                    <img src=" {{ asset('storage/image/'.$toilet->toilet_image_name) }} " class="card-img-top" alt="トイレの画像"style="object-fit: cover; height: 400px; width: 400px;">
                    <div class="card-body">
                        <h5 class="card-title">トイレの名前：<br>{{ $toilet->toilet_name }}</h5>
                ...
                <a class="btn btn-primary" href=" {{route('posts.create', ['toilet_id' => $toilet->id])}} ">Checkin</a>
            </div>
        </div>
